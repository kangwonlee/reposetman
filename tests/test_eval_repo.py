...
class TestEvalRepo(unittest.TestCase):
    ...
    def test_get_date_string_tuple_from_git_log_msg(self):
        ...
        time_list = eval_repo.get_date_string_tuple_from_git_log_msg(self.msg)
        expected = (
    ...
    def test_get_regex_parse_git_log(self):
        # function under test
        r = eval_repo.RepoEvalCountCommit.get_regex_parse_git_log()
    ...
    def te_st_eval_repo(self):
        if os.path.exists('test_eval_repo.cfg'):
            ...
            args = {
                "fields": set(),
                "re_git_log": eval_repo.get_regex_parse_git_log(),
            }
    ...
    def te_st_proc_file(self):
        ...
        if os.path.exists(config_filename):
            ...
            # function under test
            eval_repo.eval_file(arg, path, filename, arg['repo']['name'])
...
class TestSysArgv(unittest.TestCase):
    ...
    def test_is_sys_argv_00_true(self):
        ...
        result = eval_repo.is_sys_argv(self.txt)

        self.assertTrue(result)

    def test_is_argv_00_true(self):

        result = eval_repo.is_argv(self.txt)
...
class TestFromSysImportArgv(unittest.TestCase):
    ...
    def test_is_sys_argv_00_true(self):
        ...
        result = eval_repo.is_from_sys_argv(self.txt)
...
class TestRepoEvalCountOneCommitLog(unittest.TestCase):
    def setUp(self):
        self.e = eval_repo.RepoEvalCountOneCommitLog()
...
class TestRepoEvalPoundCounter(unittest.TestCase):
    ...
    def test_comments(self):
        ...
        evaluator = eval_repo.RepoEvalPoundLineCounter()
...
class TestRepoEvalRunEachBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.e = eval_repo.RepoEvalRunEachSkipSome(
...
class TestRepoEvalRunEach(TestRepoEvalRunEachBase):
    ...
    def test_get_arguments_ex23(self):
        ...
        with tempfile.TemporaryDirectory(prefix='ex23') as folder_name:
            ...
            try:
                filename = tempf.get_tempfile_name(suffix='.py')
...
class TestRepoEvalRunEachSkipSomeLastCommit(TestRepoEvalRunEachBase):
    ...
    def setUp(self):
        super().setUp()
        self.e = eval_repo.RepoEvalRunEachSkipSomeLastCommit(
            self.config['operation']['python_path'])
